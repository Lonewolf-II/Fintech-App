        ...
        for (let i = 0; i < results.length; i++) {
            ...
            try {
                ...
                const customer = await Customer.create({
                    ...
                    accountOpeningDate: new Date() // Set opening date for fee calculations
                }, { transaction });
                ...
                const accountName = `${row['Customer Name'].trim()} - ${row['Bank Name'].trim()}`;
...
export const downloadBulkUploadTemplate = async (req, res) => {
    const csvContent = `Customer Name,Mobile Number,Email,Date of Birth,Bank Name
Ram Kumar Sharma,9801234567,ram.sharma@example.com,1990-05-15,Nepal Bank Limited
Sita Devi Poudel,9841234567,sita.poudel@example.com,1985-08-20,Rastriya Banijya Bank
Hari Prasad Thapa,9851234567,hari.thapa@example.com,1995-02-10,Nabil Bank`;
